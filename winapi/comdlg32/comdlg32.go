...
func init() {
	// Library
	lib = MustLoadLibrary("comdlg32.dll")

	// Functions
	commDlgExtendedError = MustGetProcAddress(lib, "CommDlgExtendedError")
	getOpenFileName = MustGetProcAddress(lib, "GetOpenFileNameW")
	getSaveFileName = MustGetProcAddress(lib, "GetSaveFileNameW")
	printDlgEx = MustGetProcAddress(lib, "PrintDlgExW")
}
