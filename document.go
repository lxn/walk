...
type Document struct {
	...
	insertBounds Rectangle // Current bounds for pagination
}
...
func (doc *Document) AddText(text string, font *Font, color Color, preferredSize Size, format DrawTextFormat) os.Error {
	item := &simpleTextItem{
