...
func init() {
	...
	// Functions
	imageList_Add = MustGetProcAddress(lib, "ImageList_Add")
	imageList_AddMasked = MustGetProcAddress(lib, "ImageList_AddMasked")
	imageList_Create = MustGetProcAddress(lib, "ImageList_Create")
