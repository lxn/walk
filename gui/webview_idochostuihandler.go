...
func init() {
	webViewIDocHostUIHandlerVtbl = &IDocHostUIHandlerVtbl{
		uintptr(webViewIDocHostUIHandlerCbs.QueryInterface.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.AddRef.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.Release.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.ShowContextMenu.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.GetHostInfo.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.ShowUI.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.HideUI.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.UpdateUI.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.EnableModeless.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.OnDocWindowActivate.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.OnFrameWindowActivate.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.ResizeBorder.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.TranslateAccelerator.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.GetOptionKeyPath.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.GetDropTarget.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.GetExternal.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.TranslateUrl.ExtFnEntry()),
		uintptr(webViewIDocHostUIHandlerCbs.FilterDataObject.ExtFnEntry()),
	}
}
