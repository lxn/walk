...
var webViewDWebBrowserEvents2Cbs = &webViewDWebBrowserEvents2Callbacks{
	...
	syscall.NewCallback(webView_DWebBrowserEvents2_GetTypeInfoCount, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_GetTypeInfo, 4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_GetIDsOfNames, 4+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_Invoke, 4+4+4+2+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_BeforeNavigate2, 4+4+4+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_ClientToHostWindow, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_CommandStateChange, 4+2),
	syscall.NewCallback(webView_DWebBrowserEvents2_DocumentComplete, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_DownloadBegin, 0),
	syscall.NewCallback(webView_DWebBrowserEvents2_DownloadComplete, 0),
	syscall.NewCallback(webView_DWebBrowserEvents2_FileDownload, 2+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_NavigateComplete2, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_NavigateError, 4+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_NewProcess, 4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_NewWindow2, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_NewWindow3, 4+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnFullScreen, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnMenuBar, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnQuit, 0),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnStatusBar, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnTheaterMode, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnToolBar, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_OnVisible, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_PrintTemplateInstantiation, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_PrintTemplateTeardown, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_PrivacyImpactedStateChange, 16),
	syscall.NewCallback(webView_DWebBrowserEvents2_ProgressChange, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_PropertyChange, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_RedirectXDomainBlocked, 4+4+4+4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_SetPhishingFilterStatus, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_SetSecureLockIcon, 16),
	syscall.NewCallback(webView_DWebBrowserEvents2_StatusTextChange, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_ThirdPartyUrlBlocked, 4+4),
	syscall.NewCallback(webView_DWebBrowserEvents2_TitleChange, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_UpdatePageStatus, 0),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowClosing, 2+2),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowSetHeight, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowSetLeft, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowSetResizable, 2),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowSetTop, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowSetWidth, 4),
	syscall.NewCallback(webView_DWebBrowserEvents2_WindowStateChanged, 4+4),
}
